...
CREATE TABLE `dssuser` (
  ...
  `dss_username` varchar(20) NOT NULL,
  `dss_password` varchar(20) NOT NULL,
  `dss_sex` varchar(20) DEFAULT NULL,
  `dss_age` int(11) DEFAULT NULL,
  `dss_phone` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `dssuser` VALUES (1,'admin','admin',NULL,NULL,NULL),(2,'mahuan','admin',NULL,NULL,NULL);
...
-- Dump completed on 2017-05-24 13:56:49
